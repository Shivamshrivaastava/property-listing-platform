    ...
    >
      <div className="container mx-auto px-4 flex justify-between items-center">
        ...
        >
          ...
          <span className={`${isScrolled ? 'text-gray-900' : 'text-white'} transition-colors duration-300`}>
            HomeFinder
          </span>
        </Link>
  ...
  <Link
    ...
    className={`font-medium transition-colors duration-300 border-b-2 ${
      isActive 
        ...
        : `border-transparent ${isScrolled ? 'text-gray-700 hover:text-primary-600' : 'text-white hover:text-primary-100'}`
    }`}
  >
    {children}
  </Link>
